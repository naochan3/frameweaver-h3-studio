          ...
          {history.map((item) => (
            ...
            >
              {item.videoUrl && item.kind === 'image' ? (
                ...
                <div className="flex h-16 w-28 shrink-0 items-center justify-center rounded-lg bg-cream-100 text-[10px] text-ink-400">出力を確認中</div>
              )}
