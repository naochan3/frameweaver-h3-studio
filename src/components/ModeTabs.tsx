...
export function ModeTabs() {
  ...
  return (
    <nav className="scrollbar-none flex gap-1 overflow-x-auto rounded-2xl bg-surface p-1.5 shadow-sm sm:p-2">
      {MODES.map((m) => {
        ...
        return (
          <button
            ...
            className={`flex min-w-0 flex-col items-center rounded-xl px-2 py-2 transition-colors sm:px-4 ${
